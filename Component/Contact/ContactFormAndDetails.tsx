  ...
  return (
    <section className="w-full bg-white pb-20 px-6">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
        ...
        <div className="lg:col-span-7 bg-white border border-slate-100 rounded-2xl shadow-sm p-6 sm:p-8 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-[#121826] text-white hover:bg-slate-800 py-3.5 rounded-lg text-sm font-semibold uppercase tracking-widest transition-all duration-300 transform active:scale-[0.98] shadow-md cursor-pointer"
            >
              Dispatch Inquiry
            </button>
          </form>
        ...
        <div className="lg:col-span-5 flex flex-col justify-between gap-6">
          ...
          {/* Card 1: Headquarters */}
          <div className="bg-[#f8fafc] border border-slate-100 rounded-2xl p-6 shadow-sm flex-grow">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-slate-700 leading-relaxed font-sans">
                    742 Premium Avenue, Suite 100<br />
                    Corporate District, NY 10001
                  </p>
                </div>
              </div>
          ...
          {/* Card 2: Availability */}
          <div className="bg-white border border-slate-100 rounded-2xl p-6 shadow-sm flex-grow flex flex-col justify-center">
